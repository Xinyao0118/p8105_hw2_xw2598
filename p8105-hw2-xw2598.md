...
``` r
#
#Key variables:(1) Mr. Trash Wheel sheet: "weight_tons" ,"volume_cubic_yards","plastic_bottles"  ,"polystyrene","cigarette_butts" ,"glass_bottles" ,"grocery_bags" ,"chip_bags","sports_balls" ,"homes_powered", because these data need people to collect and play a core role in dataset.Other variables just work for sorting them out (2) precipitation data for 2016 and 2017: total precipitation. Because this is the core of this dataset.other variables are made for organizing and grouping "precipitation".
...
```
    ...
    ##   '/private/var/folders/f3/m8ph3n790bs8bgwwn1jqr6fw0000gn/T/RtmpTkd7q9/devtools32929459bff/P8105-p8105.datasets-21f5ad1'  \
