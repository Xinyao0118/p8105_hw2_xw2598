...
@specify the sheet in the Excel file and to omit columns containing notes (using the range argument and cell\_cols() function) @use reasonable variable names @omit rows that do not include dumpster-specific data
